...
export const UpdateCardSchema = z.object({
  ...
  board_id: z.number().positive().int().optional().describe('Move to this board ID (optional)'),
  ...
  sort_order: z.number().optional().describe('The new sort order/position (optional)'),
